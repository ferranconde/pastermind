...
public class DriverFiveGuess implements IDomainDriver {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("FiveGuess class driver");
        System.out.println("");
        ...
        IBreakerLogic breaker = new FiveGuess();
        ...
        while (option != 0) {
            switch (option) {
                case 1:
                    System.out.println("Submit a GuessResult to FiveGuess");
                    System.out.println("The code suggested by FiveGuess is:");
